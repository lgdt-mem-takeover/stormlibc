...
static inline u64 sla_u64(const u64 arg, stc_byte shift);
static inline u64 sra_u64(const u64 arg, stc_byte shift);
static inline u64 cmpnz_u64(const u64 arg);
static inline u64 select_u64(const u64 mask, const u64 arg1, const u64 arg2);
